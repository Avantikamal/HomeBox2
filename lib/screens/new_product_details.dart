...
class New_productDetails extends StatefulWidget {
 ...
 String title;
 int price;
  New_productDetails({this.image,this.title,this.price,this.wt,this.description});
  @override
  _New_productDetailsState createState() => _New_productDetailsState();
}

class _New_productDetailsState extends State<New_productDetails> {
                      ...
                      Padding(padding: EdgeInsets.only(left: 20.0,top: 10.0),
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(widget.description,style: TextStyle(color: Colors.black45,fontWeight: FontWeight.normal),),
                          ],
                        ),)
//                          Padding(
